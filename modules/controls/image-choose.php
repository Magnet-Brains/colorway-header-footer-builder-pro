...
class Image_Choose extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_register_style( 'colorwayhf-css-image-choose-control',  Init::get_url() . 'assets/css/imagechoose.css', [], '1.0.0' );
		wp_enqueue_style( 'colorwayhf-css-image-choose-control' );

		// script
		wp_register_script( 'colorwayhf-js-image-choose-control',  Init::get_url() . 'assets/js/imagechoose.js' );
		wp_enqueue_script( 'colorwayhf-js-image-choose-control' );
	}
