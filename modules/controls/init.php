...
class Init{
    ...
    public function icon( $controls_manager ) {
        ...
        $controls_manager->register_control( $controls_manager::ICON, new \ColorwayHF\Modules\Controls\Icon());
    }

    public function image_choose( $controls_manager ) {
        $controls_manager->register_control('imagechoose', new \ColorwayHF\Modules\Controls\Image_Choose());
    }
    ...
    public function widgetarea( $controls_manager ) {
        $controls_manager->register_control( 'widgetarea', new \ColorwayHF\Modules\Controls\Widget_Area());
    }
    
	public function widgetarea_enqueue_scripts_editor() {
		wp_enqueue_script( 'colorwayhf-js-widgetarea-control-editor',  self::get_url() . 'assets/js/widgetarea-editor.js' );
    }
    
	public function widgetarea_enqueue_styles_editor() {
		wp_enqueue_style( 'colorwayhf-css-widgetarea-control-editor',  self::get_url() . 'assets/css/widgetarea-editor.css', [], '1.0.0' );
    }
