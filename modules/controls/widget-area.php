...
class Widget_Area extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_register_style( 'colorwayhf-css-widgetarea-control-inspactor',  Init::get_url() . 'assets/css/widgetarea-inspactor.css', [], '1.0.0' );
		wp_enqueue_style( 'colorwayhf-css-widgetarea-control-inspactor' );

		// script
		wp_register_script( 'colorwayhf-js-widgetarea-control-inspactor',  Init::get_url() . 'assets/js/widgetarea-inspactor.js' );
		wp_enqueue_script( 'colorwayhf-js-widgetarea-control-inspactor' );
	}
	...
	public function content_template() {
		...
		?>
		<div style="display:nne" class="elementor-control-field">
