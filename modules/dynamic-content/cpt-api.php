...
class ColorwayHF_Cpt_Api extends Core\Handler_Api {
    ...
    public function get_content_editor(){
        ...
        $builder_post_id = get_page_by_title($builder_post_title, OBJECT, 'colorwayhf_content');
