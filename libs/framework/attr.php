...
class Attr{
    ...
    public function register_settings_menus(){
        ...
        // dashboard, main menu
        add_menu_page(
            esc_html__( 'ColorwayHF Settings', 'colorway-hf' ),
            esc_html__( 'ColorwayHF', 'colorway-hf' ),
            'manage_options',
            self::key(),
            [$this, 'register_settings_contents__settings'],
            self::get_url() . 'assets/images/logo-hf.png',
            59
        );

        // add_submenu_page( $parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '' )
        //add_submenu_page( self::key(), 'ColorwayHF Help', 'Help', 'manage_options', self::key().'-help', [$this, 'register_settings_contents__help'], 11);
    }


    public function register_support_menu(){
        //add_submenu_page( self::key(), esc_html__( 'Get Support', 'colorway-hf' ), esc_html__( 'Get Support', 'colorway-hf' ), 'manage_options', self::key().'-support', [$this, 'register_settings_contents__support'], 11);
