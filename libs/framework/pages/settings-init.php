<div class="iframe-con"> 
    <div class="cw_container">
        ...
        <div class="attr-row">
            ...
            <div class="attr-col-lg-1 attr-col-md-1"></div>          
            <div class="attr-col-lg-7 attr-col-md-7">            

                <div class="cw-container-iframe">
                    <div class="videobox">
                        <h2 class="cw-boxhead">
            ...
            <div class="attr-col-lg-3 attr-col-md-3">
                <div class="cw-container-help">
                    <div class="videobox1">
                        <h2 class="cw-boxhead1">
                            <span><?php esc_html_e('Prerequisites', 'colorway-hf'); ?></span>
                        </h2>
                ...
                <div class="cw-container-review">
                    <div class="videobox1">
                        <h2 class="cw-boxhead1">
                            <span><?php esc_html_e('Do you have suggestions for Colorway?', 'colorway-hf'); ?></span>
                        </h2>
                        <div class="cw-help-content">
                            <p>If you have any question regarding this plugin. Please feel free to contact us, just send us an e-mail at <a href="mailto:enquiry@inkthemes.com"> enquiry@inkthemes.com</a> <br/><br/> You can also Join our <a href="https://www.facebook.com/groups/colorwaytheme/" target="_blank"> Facebook Community</a> to get updated and for active discussion.</p> 
                        </div>
                    </div>
